...
paulFace=FR.load_image_file('C:/Users/Dell/Documents/Python/pyAI3.6/demoImages/known/Paul McWhorter.jpg')
faceLoc=FR.face_locations(paulFace)[0]
paulFaceEncode=FR.face_encodings(paulFace)[0]

gavFace=FR.load_image_file('C:/Users/Dell/Documents/Python/pyAI3.6/demoImages/known/pic.jpg')
faceLoc=FR.face_locations(gavFace)[0]
gavFaceEncode=FR.face_encodings(gavFace)[0]

knownEncodings=[paulFaceEncode,gavFaceEncode]
names=['Paul McWhorter','Berserk']
